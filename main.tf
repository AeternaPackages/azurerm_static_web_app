...
module "static_web_apps" {
  source          = "git::https://github.com/AeternaModules/azurerm_static_web_app.git?ref=v5.0.0"
  static_web_apps = local.static_web_apps
}

module "static_web_app_custom_domains" {
  source                        = "git::https://github.com/AeternaModules/azurerm_static_web_app_custom_domain.git?ref=v5.0.0"
...
module "static_web_app_function_app_registrations" {
  source                                    = "git::https://github.com/AeternaModules/azurerm_static_web_app_function_app_registration.git?ref=v5.0.0"
